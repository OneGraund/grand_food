...
WRONG_TYPE_OF_ID="Похоже на то, что ты неправильно ввёл ID кошелька ☹️ Учти, что он состоит только из девяти цифр. Попробуй ещё раз."
...
def SHOW_USER_DATA(user):
	...
	return(f"<b>👤Информация о пользователе👤:</b>\n\n<b>ID</b> - {user[0]}\n<b>Имя</b> - {user[1]}\n<b>Фамилия</b> - {user[2]}\n<b>Никнейм</b> - {user[3]}\n<b>Грандиков</b> - {user[4]}\n"
		   f"\nКласс - {grade}\nДолжность - {position}\nЗарплата - {user[8]}\nРабота - {job}\n\nЕсли ты хочешь заполнить недостающие данные, то нажми на <b>✅Закончить регистрацию✅</b> под этим сообщением и дальше ожидай, когда твои данные подтвердят.")
